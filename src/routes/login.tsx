	...
	return (
		<div className="grid min-h-screen lg:grid-cols-2 bg-neutral-950 font-sans dark text-neutral-100 selection:bg-emerald-500/30">
			...
			<div className="relative hidden lg:flex flex-col justify-end bg-neutral-900 border-r border-white/5 p-12 overflow-hidden">
				...
				<div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-emerald-800/10 blur-[100px] rounded-full z-0" />
				...
				<div className="relative z-10">
					<h2 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-white mb-4 drop-shadow-xl">
						Empowering<br/>
						<span className="text-emerald-400">Barangay Handumanan</span>
					</h2>
